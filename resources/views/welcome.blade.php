    ...
    <div id="common-home">
        ...
        <section id="collection_cities">
            <div class="container">
                ...
                <div class="left_col">
                    <!-- <img src="images/indian_made.jpg"> -->
                    ...
                    <ul id="collection_cities">
                      <li>
                        <a href="">
                          <img src="{{asset('images/delhi_icon.png')}}">
                          <span>Delhi</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          <img src="{{asset('images/ahmedabad_icon.png')}}">
                          <span>Ahmedabad</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          <img src="{{asset('images/hyderabad_icon.png')}}">
                          <span>Hyderabad</span>
                        </a>
                      </li>
                      <li>
                        <a href="">
                          <img src="{{asset('images/chennai_icon.png')}}">
                          <span>Chennai</span>
                        </a>
                      </li>
                      <li>
                    ...
                    <div id="mapwrapper">
                        <div id="map_base">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 570 600" xml:space="preserve">                                
                                ...
                                <g>
                                    <!-- <text transform="matrix(1 0 0 2 230 210)">Uttar Pradesh</text>
                                    <text transform="matrix(1 0 0 2 340 240)">Bihar</text>
                                    <text transform="matrix(1 0 0 2 325 280)">Jharkhand</text>
                                    <text transform="matrix(1 0 0 2 198 286)">Madhya Pradesh</text>
                                    <text transform="matrix(1 0 0 2 70 286)">Gujrat</text> -->
                                </g> 
                                <g id="map_points"></g>
                            </svg>
                        </div>
        ...
        <div class="box all-products special col-md-9">
            <div class="box-heading"> 
                <div class="box-content">
                    <div class="page-title toggled"><h3>New Arrivals</h3></div>
                              ...
                              <div class="product-layout col-xs-12">
                                  <div class="product-thumb transition clearfix">
                                      ...
                                      <div class="thumb-description clearfix">
                                          <div class="caption">
                                              <h4 class="product-title"><a href="indexf073.html?route=product/product&amp;product_id=30">{{ $product->title }}</a></h4>
                                              <p class="price"><span class="price-new">₹{{ $product->offer_price }}</span><span class="price-old">₹{{ $product->mrp }}</span></p>
                                              <div class="rating">
                                    ...
                                    <div class="category-thumb clearfix">
                                        <div class="images-hover image">
                                            <a href="index70a9.html?route=product/category&amp;path=57">
                                                <img src="{{asset('images/wooden.jpg')}}" alt="Women" title="Women" class="img-responsive" />
                                            </a>
                                        </div>
                                        <div class="caption">
                                            <div class="cat-title">
                                                <h4><a href="index70a9.html?route=product/category&amp;path=57">Wooden</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="category-thumb clearfix">
                                        <div class="images-hover image">
                                            <a href="index68ea.html?route=product/category&amp;path=33">
                                                <img src="{{asset('images/metal.jpg')}}" alt="Men" title="Men" class="img-responsive" />
                                            </a>
                                        </div>
                                        <div class="caption">
                                            <div class="cat-title">
                                                <h4><a href="index68ea.html?route=product/category&amp;path=33">Metal</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="category-thumb clearfix">
                                        <div class="images-hover image">
                                            <a href="index1647.html?route=product/category&amp;path=25">
                                                <img src="{{asset('images/leather.jpg')}}" alt="Accessories" title="Accessories" class="img-responsive" />
                                            </a>
                                        </div>
                                        <div class="caption">
                                            <div class="cat-title">
                                                <h4><a href="index1647.html?route=product/category&amp;path=25">Leather</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
